...
export default function TableListFilm({ listFilms }) {
    ...
    const [showFilterDate, setShowFilterDate] = useToogle();
    // hooks
    ...
    return (
        <div className="relative overflow-auto min-w-[1200px]  shadow-md sm:rounded-lg flex flex-col justify-between">
            {/* modal */}
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            {/* nut loc theo ngay */}
                            <th className="px-6 py-3 flex items-center cursor-pointer relative">
                                <div>
                                    Ngày khởi chiếu <MoreVert onClick={setShowFilterDate} />
                                </div>
                                {showFilterDate && (
                                    <InputFilterDate
                                        soTrang={filterFilm.length}
                                        soPhanTuTrenTrang={rowsPerPage}
                                        setFilms={setFilterFilm}
                                        films={filterFilm}
                                    />
                                )}
                            </th>
